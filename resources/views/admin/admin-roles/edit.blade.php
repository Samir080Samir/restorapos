...
<div class="max-w-7xl mx-auto">
    ...
    <div class="flex flex-col md:flex-row md:justify-between md:items-center gap-4 mb-8">
        ...
        <div>
            <h1 class="text-3xl font-bold text-gray-900">
                Admin rolunu redaktə et
            </h1>

            <p class="text-gray-500 mt-1">
                Rol və permission məlumatlarını yenilə
            </p>
        </div>
    ...
    <form method="POST"
        action="{{ route('admin.admin-roles.update', $adminRole->id) }}">
                    ...
                    <div class="space-y-5">
                        ...
                        <div>
                            ...
                            <textarea name="description"
                                ...
                                class="w-full border border-gray-200 rounded-2xl p-4 focus:ring-2 focus:ring-black focus:border-black resize-none">{{ old('description', $adminRole->description) }}</textarea>
                    ...
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500 mt-1">
                                Rolun giriş icazələrini idarə et
                            </p>
                        </div>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-3xl border border-gray-100 shadow-sm p-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="bg-blue-50 border border-blue-100 text-blue-700 rounded-2xl p-4 text-sm">

                            Bu sistem roludur və xüsusi qoruma aktivdir.
