...
@section('title', 'Vəzifəni redaktə et')
...
<div class="space-y-6">
    ...
    <div>
        ...
        <p class="text-sm text-slate-500 mt-1">
            Vəzifənin giriş tipini və icazələrini yeniləyin
        </p>
    </div>

    <form method="POST"
        action="{{ route('owner.staff.roles.update', $role) }}"
        class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <label class="relative cursor-pointer">
                        <input type="radio"
                            ...
                            value="pos"
                            class="peer sr-only"
                            {{ old('login_type', $role->login_type) === 'pos' ? 'checked' : '' }}>
                    ...
                    <label class="relative cursor-pointer">
                        <input type="radio"
                            ...
                            value="panel"
                            class="peer sr-only"
                            {{ old('login_type', $role->login_type) === 'panel' ? 'checked' : '' }}>
            ...
            <div class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <div class="flex items-center justify-between mb-3">
                        ...
                        <button type="button"
                            onclick="toggleGroup('{{ md5($groupName.$type) }}')"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-3">
                        ...
                        <label class="permission-group-{{ md5($groupName.$type) }} flex items-start gap-3 p-4 rounded-2xl border border-slate-200 hover:bg-slate-50 cursor-pointer transition">
...
<script>
    function toggleGroup(groupClass) {
        const labels = document.querySelectorAll('.permission-group-' + groupClass);
