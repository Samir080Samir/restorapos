    ...
    <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        ...
        <div>
            ...
            <p class="text-sm text-slate-500 mt-1">
                Mətbəx, Bar, Fast Food və digər şöbələrin idarə olunması.
            </p>
        </div>

        <a href="{{ route('owner.menu.departments.create') }}"
                    ...
                    <tr class="hover:bg-slate-50 transition">
                        ...
                        <td class="px-5 py-4">
                            ...
                            <div class="w-11 h-11 rounded-2xl border border-slate-200 shadow-sm"
                                style="background-color: {{ $department->color ?? '#334155' }};">
                            </div>
                        ...
                        <td class="px-5 py-4">
                            ...
                            <div class="flex items-center justify-end gap-2">
                                ...
                                <a href="{{ route('owner.menu.departments.edit', $department->id) }}"
                                ...
                                <form method="POST"
                                    action="{{ route('owner.menu.departments.destroy', $department->id) }}"
                                    onsubmit="return confirm('Şöbə silinsin?')">
                        ...
                        <td colspan="6" class="py-24 text-center">
                            ...
                            <div class="max-w-md mx-auto">
                                ...
                                <p class="text-sm text-slate-500 mt-2 leading-6">
                                    İlk şöbənizi yaradaraq məhsulları bölmələrə ayırın.
                                </p>
